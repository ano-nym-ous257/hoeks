    ...
    >
      ...
      <div className="system-skills-grid">
        {skillGroups.map((group, groupIndex) => {
          ...
          return (
            <article className="system-skill-module" key={group.title}>
      ...
      <div className="skills-summary-panel">
        <div>
          ...
          <div>
            ...
            <h3>Security-first, systems-focused and operationally aware.</h3>
          </div>
        </div>

        <p>
          Every capability is applied with attention to reliability, access
          control, troubleshooting, documentation and long-term maintainability.
        </p>
      </div>
    </section>
  );
